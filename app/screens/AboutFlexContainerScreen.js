    ...
    <SafeAreaView edges={['left', 'right']}>
      ...
      <ScrollView>
        <View style={styles.containerView}>
          ...
          <TeachingText>
            Flexbox manages how elements or views are laid out on the screen in a flex container.  The first step towards using flex is simply to assign "flex" to the "display" style property.  This will make the container a flexbox container so that you can use flexbox for determining how the views are arranged in the container.
          </TeachingText>
          ...
          <TeachingText>
            If your flex container view has a size assigned to it, such as from assigning it a width and a height, you can assign the "flex-wrap" property "wrap" and flexbox will try to wrap your views to fit within the flex container.  Alternately, you can not assign it a size and can assign it "nowrap" and your flex container will expand in a line to fit all your views inside of it.  Lastly, you can assign it "wrap-reverse" and a size and it will lay out your views with the rows or columns starting at the opposite end.
          </TeachingText>
          <ContainerTeachingTitle>flex-direction</ContainerTeachingTitle>
          <TeachingText>
            "flex-direction" determines the overall flow of how your views are laid out.  If you asign it "row", it will have your items in your flex container laid out from left to right, wrapping to fit the container if you have a defined size for the container and have assigned "wrap" to the "flex-wrap" property. If you assign it "column", it will do the same things but laid out from top to bottom.  If you assign it "row-reverse", it will make everything go from right to left, and if you assign it "column-reverse", it will make everything go from bottom to top.
          </TeachingText>
          ...
          <TeachingText>
            ...
            this axis.  "flex-end" will have your content be aligned at the end of this axis.  "center" will have your content aligned at the center of this axis. "space-between" will have the content spread out as much as possible along this axis.  "space-around" will spread the content out across the axis, with space spread around each view or element.  "space-evenly" will have the space divided up and put equally between elements and at the beginning and end of the axis.
          </TeachingText>
          ...
          <TeachingText>
            ...
            aligns the items "baselines" (think aligning along the baseline of their text or similar content).
          </TeachingText>
        </View>
        <SpacerView />
      </ScrollView>
