    ...
    <SafeAreaView edges={['left', 'right']}>
      ...
      <ScrollView>
        <View style={styles.containerView}>
          ...
          <TeachingText>
            Flexbox manages how elements or views are laid out on the screen in a flex container.  The first step
          ...
          <TeachingText>
            ...
            the flex container.  Alternately, you can not assign it a size and can assign it "nowrap" and your 
            flex container will expand in a line to fit all your views inside of it.  Lastly, you can assign it 
            "wrap-reverse" and a size and it will lay out your views with the rows or columns starting at the 
            opposite end.
          </TeachingText>
          <ContainerTeachingTitle>flex-direction</ContainerTeachingTitle>
          <TeachingText>
            "flex-direction" determines the overall flow of how your views are laid out.  If you asign it "row",
            it will have your items in your flex container laid out from left to right, wrapping to fit the
            container if you have a defined size for the container and have assigned "wrap" to the "flex-wrap" property.
            If you assign it "column", it will do the same things but laid out from top to bottom.  If you assign
